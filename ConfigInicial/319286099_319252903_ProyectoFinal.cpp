...
glm::vec3 posicionBoquilla = glm::vec3(3.068f, 0.99259f, -6.45883f);
...
float alturaLavabo = 0.8556f;  // Fondo del lavabo donde salpican
...
int main()
{
    ...
    // Create window
    GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "319252903_ProyectoFinalTeoria_Grupo05", nullptr, nullptr);
